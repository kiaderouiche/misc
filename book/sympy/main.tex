...
\include{first/avant_propos}

\chapterimage{head2.png} % Chapter heading image
\include{first/firststep}
%----------------------------------------------------------------------------------------
%	CHAPTER 1
%----------------------------------------------------------------------------------------
\include{chapter1/basecalculs}
%----------------------------------------------------------------------------------------
%	CHAPTER 2
%----------------------------------------------------------------------------------------
\part{Logique, ensembles et théorie des catégories}
\include{chapter2/logic}
\include{chapter2/ensemble}
\include{chapter2/category}
%----------------------------------------------------------------------------------------
%	CHAPTER 3
%----------------------------------------------------------------------------------------
\part{Algèbre et théorie des nombres}
\include{chapter3/ringfinitefiled}
\include{chapter3/polynomes}
\include{chapter3/linearalgebra}
\include{chapter3/systempolynom}
\include{chapter3/symbolicdiffequ}
\include{chapter3/recurrsquence}
...
\include{chapter4/plangeometry}
\include{chapter4/projecgeometr}
\include{chapter4/diffgeometry}
\include{chapter4/liegeometry}
\include{chapter4/trigolorentz}
%-------------------------------------------------------------------------------------------------
%   CHAPTER 5
%-------------------------------------------------------------------------------------------------
\part{Calcul numérique et discret}\index{Calcul numérique et discret}
\include{chapter5/floatappro}
\include{chapter5/numalgebra}
\include{chapter5/numintgration}
\include{chapter5/integrtransform}
%-------------------------------------------------
...
%----------------------------------------------------------------------------------------
\include{chapter6/combina}
%----------------------------------------------------------------------------------------
\part{Physique}
\include{chapter7/chaos}
\include{chapter7/quantum}
%----------------------------------------------------------------------------------------
%	Technique Avancée
%----------------------------------------------------------------------------------------

\part{Annexe}
\include{annexe/poo/intropoo}
\include{annexe/decor/decorator}
...
\include{annexe/optimization/cython}
\include{annexe/optimization/theano}
\include{annexe/gui/qt}
