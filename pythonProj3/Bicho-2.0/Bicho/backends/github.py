...
class GithubIssue(Issue):
    ...
    def set_closed_at(self, closed_at):
        ...
        if not isinstance(closed_at, datetime):
            raise ValueError(f'Parameter "closed_at" should be a {'datetime'} '
                             'instance. {input.__class__.__name__} given.')
    ...
    def set_updated_at(self, updated_at):
        ...
        if not isinstance(updated_at, datetime):
            raise ValueError('Parameter "updated_at" should be a {'datetime'} '
                             'instance. {input.__class__.__name__} given.')
...
class GithubBackend(Backend):
    ...
    def __to_datetime(self, str) -> str:
    ...
    def __get_project_from_url(self) -> str:
    ...
    def __get_batch_activities(self, bug_number) -> str:
    ...
    def __get_batch_comments(self, bug_number) -> str:
    ...
    def __get_batch_bugs_state(self, state=ALL_STATES, since=None, direction='asc') -> str:
    ...
    def run(self):
        print(f"Running Bicho with delay of {str(self.delay)} seconds")
        ...
        while len(bugs) > 0:
            ...
            for bug in bugs:
                ...
                try:
                    ...
                    printerr(
                        f"UnicodeEncodeError: the issue {issue_data.issue} couldn't be stored")
        ...
        printout("Done. {nbugs} bugs analyzed")
