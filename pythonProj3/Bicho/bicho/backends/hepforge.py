# -*- coding: utf-8 -*-
#
# Copyright (C) 2021-2020 K.I.A.Derouiche <kamel.derouiche@gmail.com>
#
...
class DBStoryBoardBackend(DBBackend):
    ...
    def insert_story(self, store, story):
        ...
        try:
            ...
            db_story.tags = str(";".join(story['tags']))
...
class StoryBoard():
    ...
    def parse_change(self, change):
        ...
        change = Change(field, str(old_value), str(new_value), by, update)
        return change
    ...
    def analyze_tasks(self):
        ...
        f = urllib.request.urlopen(self.url_tasks_total)
        ...
        while start_page <= total_pages:
            ...
            f = urllib.request.urlopen(self.url_tasks_page)
    ...
    def check_tasks_events (self):
        ...
        people_none = self.bugsdb.store.find(DBPeople, DBPeople.user_id == str("None")).one()
        for task in issues:
    ...
    def analyze_stories_and_events(self):
        ...
        f = urllib.request.urlopen(self.url_stories_total)
        ...
        while start_page <= total_pages and updated_stories:
            ...
            f = urllib.request.urlopen(self.url_stories_page)
        ...
        for story_id in storiesUpdated:
            ...
            f = urllib.request.urlopen(url_events)
            data = f.read()
            ...
            for event in events:
                ...
                if 'task_id' in list(event['event_info'].keys()):
                    task_id = event['event_info']['task_id']
                    issue = self.bugsdb.store.find(DBIssue, DBIssue.issue == str(task_id)).one()
                    if issue is None:
    ...
    def get_user_field(self, user_id, field) -> str:
    ...
    def get_fullname(self, user_id) -> str:
    ...
    def analyze_users(self):
        ...
        f = urllib.request.urlopen(self.url_users_total)
        ...
        while start_page <= total_pages:
            ...
            f = urllib.request.urlopen(self.url_users_page)
